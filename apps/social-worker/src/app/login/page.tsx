      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-extrabold text-gray-900">
            Social Worker Portal Login
          </CardTitle>
          <CardDescription className="text-gray-600">
            Sign in to your social worker account
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="mt-6 bg-gray-50 p-4 rounded-md">
              <h3 className="text-sm font-medium text-gray-900 mb-2">Test Social Worker Account:</h3>
              <div className="text-xs text-gray-600 space-y-1">
                <div><strong>Email:</strong> social1@artistryhub.com</div>
                <div><strong>Password:</strong> Social2024!Help#</div>
              </div>
            </div>
          </form>
        </CardContent>
